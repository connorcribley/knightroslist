                                ...
                                {(typeof backendData.university === 'undefined') ? (
                                    ...
                                    <div className="card mb-3">
                                        ...
                                        <ul className="list-group list-group-flush">
                                            ...
                                            <li className="list-group-item">In-State Tuition: ${backendData.university.ISTuition}</li>
                                            <li className="list-group-item">Out-Of-State Tuition: ${backendData.university.OOSTuition}</li>
                                        </ul>
                                        {(isLoggedIn && typeof user !== 'undefined' && user._id === backendData.university.author._id) ? (
                                            <div className="card-body">
                                                <a href={`/universities/${id}/edit`} className="card-link btn btn-info">Edit University</a>
